...
export default function SGPACalculatorPage() {
  ...
  return (
    <div className="min-h-screen bg-sdash-bg text-sdash-text-primary pb-28">
      <TopAppBar title="SGPA Calculator" showBack />

      <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-6">
        <div className="max-w-4xl mx-auto font-sora">
          <div className="relative p-3 sm:p-6 backdrop-blur bg-white/[0.06] border border-white/[0.1] rounded-3xl">
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-center mb-4 sm:mb-6 text-sdash-text-primary">
              SGPA Calculator
            </h1>
